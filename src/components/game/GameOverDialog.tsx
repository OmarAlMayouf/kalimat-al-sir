      ...
      <div className="relative z-10 bg-card border border-border/60 rounded-2xl p-8 max-w-sm w-full text-center animate-scale-in shadow-xl space-y-6">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="text-center flex-1">
            <div
              className={`w-full py-3 rounded-xl font-black text-2xl flex items-center justify-center transition-all ${
                isRed
                  ? "bg-team-red text-team-red-foreground ring-2 ring-team-red/50 shadow-lg"
          ...
          <span className="text-muted-foreground/40 font-bold text-lg pb-5">
            –
          </span>
          ...
          <div className="text-center flex-1">
            <div
              className={`w-full py-3 rounded-xl font-black text-2xl flex items-center justify-center transition-all ${
                !isRed
                  ? "bg-team-blue text-team-blue-foreground ring-2 ring-team-blue/50 shadow-lg"
