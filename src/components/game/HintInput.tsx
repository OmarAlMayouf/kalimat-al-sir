    ...
    `}>
            ...
            <div className="flex gap-2 items-end">
                ...
                <div className="flex-1">
                    <label className="text-[11px] text-muted-foreground mb-1 block font-medium">الكلمة</label>
                    <Input
                        value={hintWord}
                ...
                {/* Count stepper */}
                <div>
                    <label className="text-[11px] text-muted-foreground mb-1 block font-medium text-center">العدد</label>
                    <div className="flex items-center gap-1 h-10">
                        ...
                        <span className="w-8 text-center font-bold text-base tabular-nums">{hintCount}</span>
                        <button
